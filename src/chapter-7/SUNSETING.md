...
Imagine if you have some code in old technology, let's say Python 2.x. Now using coding agents it's possible to migrate the code base from Python 2.x to Rust for instance. This is a unique time that provides us great opportunities. Now we need to tweak our mindset and leverage the new tools.