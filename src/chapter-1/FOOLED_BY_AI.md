...
AI it's capable to find a bug you created in your code. However when you ask AI todo something AI will create bug and get stuck and wont be able to fix it.So at same time it's "Intelligent" and "Dumb".

<img src="../images/01-AI-paradox.png" width="600" >

PS: Image generated by Gemini 3 - Banana Pro

When I asked for this image, I asked for a complilation error, it's written on the words but the image actually has no compilation error, just a comment in the code saying there is no errors. By asking AI to generate a image for me, I was able to proof the paradox once again.