...
* OpenAI's [GPT-5](https://openai.com/index/gpt-5-system-card/) and GPT-4
* Anthropic's [Sonnet 4.5](https://assets.anthropic.com/m/12f214efcc2f457a/original/Claude-Sonnet-4-5-System-Card.pdf) and Opus
* Google's [Gemini 2.0 Flash](https://modelcards.withgoogle.com/assets/documents/gemini-2-flash.pdf)
* Meta's [LLaMA 4](https://www.llama.com/docs/model-cards-and-prompt-formats/llama4/)
* XAI's [Grok 4](https://data.x.ai/2025-08-20-grok-4-model-card.pdf)