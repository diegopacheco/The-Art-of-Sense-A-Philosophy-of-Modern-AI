...
This [paper](https://arxiv.org/pdf/2506.10943) introduces a framework for LLM models to autonomously update their own weights. You might think OH BOY the machines are going to take over. Wait. In the same paper:
...
I totally understand why people would think that. You see AI coding, you see AI winning competitive programming contests, you see AI doing very well in benchmarks, and things seem to be moving fast. Elon Musk said we would have [Elon Musk: AGI by 2025](https://www.reddit.com/r/singularity/comments/1p81boq/elon_musk_predicted_that_agi_would_arrive_in_2025/). Elon Musk predicted that AGI would arrive in 2025 (did not happen). Sam Altman said we would have [Sam Altamn: Implied AGI by 2025](https://firstmovers.ai/agi-2025/#:~:text=Altman%20reaffirmed%20that%20OpenAI's%20focus,AGI%20a%20reality%20by%202025.) (we don't have it). So, there is a lot of hype around AGI. Anthropic CEO said that we can have [Dario: AGI by 2026/2027](https://www.reddit.com/r/singularity/comments/1gp2o2m/anthropics_dario_amodei_says_unless_something/). Very likely we won't have it by then.

More [grounded quotes](https://medium.com/@anwarzaid76/agi-is-not-possible-even-in-10-years-013a1aec0d9c) aim 20 years or more: ["chance that AI will be doing most cognitive tasks by 2045"](https://helentoner.substack.com/p/long-timelines-to-advanced-ai-have). IMHO it can be even more than that—could be 50 or even more than 100+ years.
